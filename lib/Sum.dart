...
class VectorSum extends StatelessWidget {
  ...
  void calculateVectorSum() {
    ...
    if (x1.isNotEmpty &&
        ...
        y2.isNotEmpty &&
        z2.isNotEmpty) {
      double sumX = double.parse(x1) + double.parse(x2);
      double sumY = double.parse(y1) + double.parse(y2);
      double sumZ = double.parse(z1) + double.parse(z2);

      resultController.text = '($sumX x, $sumY y, $sumZ z)';
    } else {
