...
class dotPrpduct extends StatelessWidget {
  ...
  void calculateDotProduct() {
    ...
    if (x1.isNotEmpty && y1.isNotEmpty && z1.isNotEmpty &&
        x2.isNotEmpty && y2.isNotEmpty && z2.isNotEmpty) {
      double result =
          double.parse(x1) * double.parse(x2) +
              double.parse(y1) * double.parse(y2) +
              double.parse(z1) * double.parse(z2);
